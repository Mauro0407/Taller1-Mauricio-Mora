...
using Microsoft.AspNetCore.Mvc.Rendering;//hola
using Microsoft.EntityFrameworkCore;
using Taller1_Mauricio_Mora.Data;
using Taller1_Mauricio_Mora.Models;

namespace Taller1_Mauricio_Mora.Controllers
{
    public class EstadiosController : Controller
    {
        private readonly Taller1_Mauricio_MoraContext _context;

        public EstadiosController(Taller1_Mauricio_MoraContext context)
        {
            _context = context;
        }
